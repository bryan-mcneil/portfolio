...
The site doubles as an SEO lab. I'm experimenting with JSON-LD structured data for products, merchandise, and brands, and learning Google's ad policies and approval process along the way. It's an ongoing process, with big shifts as I learn new things.
...
- Admin frontend: React 19 with Inertia.js v2
